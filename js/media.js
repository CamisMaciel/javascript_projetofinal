...
function calcularMedia() {
    ...
    if (media == 0){
        ...
        mensagem = "Caramba, deu ruim, você obteve nota " +media+ ". Estude mais e tente novamente! ";
    }
    else if (media >= 3.1 && media <= 5.9){
        mensagem = "Você obteve nota " +media+ ". Falta pouco para a média.";
    }
        ...
        mensagem = "Hoje é o seu aniversário? Porque você está de parabéns! Sua média é um show, 10!";
    }
    else {
        mensagem = "Amigue, tá tudo bem?";
    }
